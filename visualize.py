...
if __name__ == '__main__':
  ...
  arg.add_argument('-o', '--optimize', default=False,
                   type=bool, help='turn on to enable optimize, note that only if ir was enabled will this option make sense')
  ...
  arg.add_argument('-g', '--graphic', default=False,
                   type=bool, help='turn on to enable visualize')
  arg.add_argument('-j', '--jit', default=False, type=bool,
                   help='turn on to enable jit(NOT compatible with graphic), with this on, you CANNOT pass input by argument, please use a pipe')
  arg.add_argument('-r', '--ir', default=True, type=bool,
                   help='turn on to enable ir')
  args = arg.parse_args()
  jit = args.jit
  graphic = (not jit) and args.graphic
  if graphic:
    import pygame
    pygame.init()
